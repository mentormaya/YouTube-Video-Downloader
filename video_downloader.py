...
URL = 'https://prmovies.com/episode/the-good-doctor-season-1-episode-5/'
...
def download(m3u8_file, fname = 'Film', dir = 'C:\Movies', headers = customized_http_header):
    ...
    mp4.multithread_download(
        stream['url'], customized_http_header=headers, 
        mp4_file_dir = dir, 
...
def generate_url(streaming_url):
    ...
    sep = '7c7c'
    return generate_link(streaming_url, '/sources48/') + sep.join([get_random_id(24), m5cod5c7ole6, get_random_id(24), streamsb])
